...
$pending_count_query = "SELECT COUNT(*) as count FROM inquiries WHERE student_id = {$user['id']} AND status = 'pending'";
...
<head>
    ...
    <title>Student Dashboard - iSCSS</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <a href="create_inquiry.php" class="btn btn-primary">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">My Inquiries & Claims</h5>
                    </div>
                    <div class="card-body">
