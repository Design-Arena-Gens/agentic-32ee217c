...
check_role(['office_staff']);

$conn = db_connect();
$user = get_current_user($conn);

// Get inquiries addressed to this staff member
$inquiries_query = "
...
<head>
    ...
    <title>Staff Dashboard - iSCSS</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Office Staff Dashboard</h1>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Student Inquiries & Claims</h5>
                    </div>
                    <div class="card-body">
